const Contact = () => {
  return (
    <div className="contact tc">
      <div className="pa5">
        <h1>Contact</h1>
        <div className="contact__container">
          <a
            className="link b black bg-transparent hover-purple inline-flex items-center ma2 tc br2 pa2"
            href="https://github.com/jrleijnse"
            title="GitHub"
          >
            <svg
              className="dib h2 w2"
          ...
          <a
            className="link b black bg-transparent hover-blue inline-flex items-center ma2 tc br2 pa2"
            href="https://www.linkedin.com/in/jeroen-leijnse/"
            title="LinkedIn"
          >
            <svg
              className="dib h2 w2"
          ...
          <a
            className="link b black bg-transparent hover-red inline-flex items-center ma2 tc br2 pa2"
            href="mailto: jr_leijnse@live."
            title="Email"
          >
            <svg
              className="dib h2 w2"
